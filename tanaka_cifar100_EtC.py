...
trainset = torchvision.datasets.CIFAR100(root='./data_cifar10', train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=512, shuffle=True, num_workers=16)

testset = torchvision.datasets.CIFAR100(root='./data_cifar10', train=False, download=True, transform=transform_test)
